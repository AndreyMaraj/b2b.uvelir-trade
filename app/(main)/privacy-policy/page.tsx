export default function () {
	return (
		<>
			...
			<div>
				<p>Настоящая Политика конфиденциальности регулирует порядок обработки и использования персональных данных физических лиц, пользующихся сервисами Сайта www.b2b.uvelir-trade.ru ООО «ЮвелирТрейд» (далее — Оператор).</p>
				...
				<p>7.1. ООО «ЮвелирТрейд»</p>
				<p>(ИНН )</p>
				<p>7.2. Телефон: </p>
				<p>7.3. E-mail: </p>
				<p>7.4. Адрес для направления обращений клиентов по вопросам исполнения услуг, пользования сервисом, пожеланий и предложений, направленных по адресу: </p>
			</div>
		</>
	)
}